...
import org.dromara.im.domain.bo.ModifyPasswordForm;
...
public class ImUserController extends BaseController {
     ...
     * 修改资产
     */
    /*@SaCheckPermission("business:user:modifyAsset")
    @Log(title = "修改资产", businessType = BusinessType.INSERT)
    @RepeatSubmit()
    @PostMapping("/modifyAsset")
    public R<Void> modifyAsset(@Validated @RequestBody ModifyAssetForm modifyAssetForm) {
        userFoundServiceFacade.modifyUserFound(modifyAssetForm.getUserId(),
                null,
                null,
                UserFoundEnum.BALANCE,
                TransferFlagEnum.of(modifyAssetForm.getTransferFlag()),
                modifyAssetForm.getAmount(),
                modifyAssetForm.getDescribes(),
                modifyAssetForm.getRemark());
        return toAjax(true);
    }*/
     ...
     * 修改密码
     */
    /*@SaCheckPermission("business:user:modifyPasswordBackend")
    @Log(title = "修改密码", businessType = BusinessType.INSERT)
    @RepeatSubmit()
    @PostMapping("/modifyPasswordBackend")
    public R<Void> modifyPasswordBackend(@Validated @RequestBody ModifyPasswordForm modifyPasswordForm) {
        return toAjax(userService.modifyPasswordBackend(modifyPasswordForm));
    }*/
     ...
     * 新增IM用户
     */
    @SaCheckPermission("business:banner:add")
    @Log(title = "IM用户", businessType = BusinessType.INSERT)
    @RepeatSubmit()
    @PostMapping()
    public R<Void> add(@RequestBody ImUserBo bo) {
     ...
     * 修改IM用户
     */
    @SaCheckPermission("business:banner:edit")
    @Log(title = "IM用户", businessType = BusinessType.UPDATE)
    @RepeatSubmit()
    @PutMapping()
    public R<Void> edit(@RequestBody ImUserBo bo) {
    ...
    public R<Void> modifyPassword(@RequestBody ImUserBo bo) {
