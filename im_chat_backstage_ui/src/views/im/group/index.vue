  ...
  <div class="p-2">
    ...
    <el-card shadow="never">
      <el-table v-loading="loading" :data="groupList" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="是否开启禁言" align="center" prop="isMuted">
          <template #default="scope">
            <dict-tag :options="im_bool" :value="scope.row.isMuted" />
          </template>
        </el-table-column>
    ...
    <el-dialog :title="dialog.title" v-model="dialog.visible" width="800px" append-to-body>
      <el-form ref="groupFormRef" :model="form" label-width="100px" disabled>
        ...
        <el-form-item label="是否开启禁言" prop="isMuted">
          <dict-tag :options="im_bool" :value="form.isMuted" />
        </el-form-item>
