...
export default {
	...
	methods: {
		...
		handlePrivateMessage(msg) {
			...
			// 好友在线状态更新
			if (msg.type == enums.MESSAGE_TYPE.FRIEND_ONLINE) {
		...
		insertPrivateMessage(friend, msg) {
			...
			// 插入消息
			if (msgType.isNormal(msg.type) || msgType.isTip(msg.type) || msgType.isAction(msg.type) || msgType.isRedPackage(msg.type)) {
				let chatInfo = {
					type: 'PRIVATE',
					targetId: friend.id,
