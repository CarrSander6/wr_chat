  ...
  <view class="page group-edit">
    ...
    <view class="form">
      ...
      <view class="form-item">
        ...
        <input v-if="isOwner && isManager" class="input" :class="isOwner || isManager ? '' : 'disable'" maxlength="20"
          v-model="group.name" :disabled="!isOwner && !isManager" placeholder="请输入群聊名称" />
          <view v-else class="input disable" :class="isOwner || isManager ? '' : 'disable'">{{group.name}}</view>
      </view>
      <view class="form-item">
