		...
		<view class="member-items">
			...
			<view class="member-item">
				<head-image size="small" :name="ownerMember.showNickName" :online="ownerMember.online"
					:url="ownerMember.headImage" :clickable="false"></head-image>
			...
			<view v-for="m in managerMembers">
				<view class="member-item">
					<head-image size="small" :name="m.showNickName" :online="m.online" :url="m.headImage" :clickable="false"></head-image>
