<template>
	<view class="chat-private-video">
		<web-view fullscreen="false" id="chat-video-wv" @message="onMessage" :src="webviewUrl"></web-view>
	</view>
</template>
...
export default {
	...
	methods: {
		...
		initUrl() {
			this.webviewUrl = "/hybrid/html/rtc-private/index.html";
			this.webviewUrl += "?mode=" + this.mode;
			...
			this.webviewUrl += "&friend=" + this.encodeURI(this.friend);
