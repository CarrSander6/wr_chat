<template>
	<view class="chat-history-item">
		<view class="chat-message">
			<head-image class="avatar" :id="msgInfo.sendId" :url="headImage" :name="showName" size="small" :clickable="false"></head-image>
			<view class="chat-content">
				...
				<view class="chat-bottom">
					...
					<view v-if="msgInfo.type == $enums.MESSAGE_TYPE.RED_PACKAGE">
						<view class="chat-text red-package-history">
							🧧 [红包] {{data.title || '恭喜发财，大吉大利'}}
						</view>
					</view>
